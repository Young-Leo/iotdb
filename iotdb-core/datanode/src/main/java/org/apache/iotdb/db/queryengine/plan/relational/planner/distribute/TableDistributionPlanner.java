...
import org.apache.iotdb.db.queryengine.plan.planner.distribution.TableModelWriteFragmentPlanner;
  ...
  public DistributedQueryPlan plan() {
    ...
    List<FragmentInstance> fragmentInstances =
        mppQueryContext.getQueryType() == QueryType.READ
            ? new TableModelQueryFragmentPlanner(subPlan, analysis, mppQueryContext).parallelPlan()
            : new TableModelWriteFragmentPlanner(subPlan, analysis, mppQueryContext).parallelPlan();
