...
public class TableModelWriteFragmentPlanner implements IFragmentParallelPlaner {

  private final SubPlan subPlan;
  private final Analysis tableAnalysis;
  private final MPPQueryContext queryContext;

  public TableModelWriteFragmentPlanner(
      SubPlan subPlan, Analysis tableAnalysis, MPPQueryContext queryContext) {
  ...
  public List<FragmentInstance> parallelPlan() {
    ...
    Expression globalTimePredicate = tableAnalysis.getGlobalTableModelTimePredicate();
    ...
    List<WritePlanNode> splits = ((WritePlanNode) node).tableModelSplitByPartition(tableAnalysis);
      ...
      FragmentInstance instance =
          new FragmentInstance(
              ...
              globalTimePredicate == null
                  ? null
                  : new TableModelTimePredicate(tableAnalysis.getGlobalTableModelTimePredicate()),
